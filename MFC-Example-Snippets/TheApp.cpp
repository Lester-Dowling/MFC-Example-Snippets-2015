...
BOOL TheApp::InitInstance()
{
	...
	else if (cmdInfo.m_nShellCommand == CCommandLineInfo::AppUnregister)
	{
		...
		AfxOleUnregisterTypeLib(LIBID_MFCExampleSnippets, _wVerMajor, _wVerMinor);
		return FALSE;
	}
	...
	else
	{
		...
		AfxOleRegisterTypeLib(AfxGetInstanceHandle(), LIBID_MFCExampleSnippets);
		if (cmdInfo.m_nShellCommand == CCommandLineInfo::AppRegister)
			return FALSE;
	}

	ExampleSnippetsDialog dlg;
	m_pMainWnd = &dlg;
